...
if (!empty($_POST)) {
	...
	$sql = 'SELECT user_id FROM users WHERE user_type = 2 AND email = "' . $email . '" AND password = "' . $password . '"';
...
<!--==============================Content=================================-->
			<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - April 07, 2014!</div>
				<div class="container_12">
					<h3>Transport Provider Sign In</h3>

					<form id="login_form" class="form <?php echo $errClass; ?> login-form" method="post" src="driver-login.php">
						<div class="success_wrapper">
							<div class="success-message"><?php echo $errMsg; ?></div>
						</div>
						<label class="email">
							<input type="text" placeholder="E-mail or Mobile Number:" data-constraints="@Required" name="email" />
