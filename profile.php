...
if (!empty($_POST)) {
    ...
    $driverAadhar = $_POST['driveraadhar'];
				...
				<div class="container_12">
					...
					<form id="register_form" class="login-form form <?php echo $successClass; ?>" method="post" action="profile.php"
                        ...
                        <label class="driver-gender">
                            <input type="text" placeholder="Driver Gender:" data-constraints="@Required"
                                   name="drivergender" value="<?php echo $driverGender; ?>" />
                            <span class="empty-message">*This field is required.</span>
                        </label>
                        ...
                        <label class="driving-license">
                            <input type="text" placeholder="Driving License Document:" data-constraints="@Required"
                                   name="drivinglicense" value="<?php echo $drivingLicense; ?>" />
                            <span class="empty-message">*This field is required.</span>
                        </label>
                        <label class="driver-aadhar">
                            <input type="text" placeholder="Driver Aadhar Document:" data-constraints="@Required"
